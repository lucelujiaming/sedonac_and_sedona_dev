...
//////////////////////////////////////////////////////////////////////////
                     ...
                     String strThirdBend)
  {
    ...
    this.toComp   = toComp;
    this.toSlot   = toSlot;
    this.firstBend = strFirstBend;
    this.secondBend = strSecondBend;
    this.thirdBend = strThirdBend;
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  public void encodeXml(XWriter out)
  {
    out.w("  <link ")
       ...
       .attr("to", toComp.path() + "." + toSlot.name).w(" ")
       // Add bendPercent
       .attr("firstBend", firstBend).w(" ")
       .attr("secondBend", secondBend).w(" ")
       .attr("thirdBend", thirdBend)
       .w("/>\n");
  }
    ...
    throws Exception
  {
    ...
    // Add bendPercent
    String strFirstBend = xml.get("firstBend");
    String strSecondBend = xml.get("secondBend");
    String strThirdBend = xml.get("thirdBend");
...
//////////////////////////////////////////////////////////////////////////
  ...
  public void encodeBinary(Buf out)
  {
    ...
    out.u1(toSlot.id);
    // Add bendPercent
    out.u2(Integer.parseInt(firstBend));
    out.u2(Integer.parseInt(secondBend));
    out.u2(Integer.parseInt(thirdBend));
  }
    ...
    throws Exception
  {
    ...
    int toSlotId   = in.u1();
    // Add bendPercent
    int iFirstBend    = in.u2();
    int iSecondBend    = in.u2();
    int iThirdBend    = in.u2();
    ...
    return new OfflineLink(from, fromSlot, to, toSlot, 
        Integer.toString(iFirstBend), 
        Integer.toString(iSecondBend), 
        Integer.toString(iThirdBend));
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  public Slot toSlot;
  public String  firstBend;
  public String  secondBend;
  public String  thirdBend;
