...
def archive():
  ...
  print "LULULU ----------------------- manifest = (" + manifest + ")"
  ...
  print "LULULU ----------------------- platformId = (" + platformId + ")"
  ...
  if doSvm and os.path.isdir(svmDir):
    ...
    for sf in os.listdir(svmDir):
      ...
      print "LULULU ----------------------- sf = (" + os.path.join(os.path.join(svmDir, sf)) + ")"
  zip.close()
  print "LULULU ----------------------- zip.close "
  
  if (doDb): 
    addToPlatformDb(platformId)
...
def addToPlatformDb(platformId):
  ...
  cmd = cmd + " -i " + outFile
  print "LULULU ----------------------- addToPlatformDb.cmd = (" + cmd + ")"
