...
// pick first item.
static __inline list_node_t *list_get(list_head_t *head)
{
...
// append item at end.
static __inline void list_put(list_head_t *head, list_node_t *node)
{
    if (head->len++)
        head->last->next = node;
    else
...
// pick last item.
static __inline list_node_t *list_get_last(list_head_t *head)
{
    list_node_t *pre = NULL;
    list_node_t *node = head->first;
    if (!node)
...
static __inline void list_put_begin(list_head_t *head, list_node_t *node)
{
...
// delete item
static __inline void list_delete(list_head_t *head, list_node_t *node)
{
