...
extern "C" Cell ModBus_remDev_dRtuO(SedonaVM* vm, Cell* params)
{
...
extern "C" Cell ModBus_remDev_dRtuC(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
...
extern "C" Cell ModBus_remDev_dRtuA(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
...
extern "C" Cell ModBus_remDev_dRtuR(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_remDev_dRtuW(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_locDev_dRtuO(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int band = params[2].ival;
    int parity = params[3].ival;
...
extern "C" Cell ModBus_locDev_dRtuC(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
...
extern "C" Cell ModBus_locDev_dRtuA(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_locDev_dRtuR(SedonaVM* vm, Cell* params)
{
...
extern "C" Cell ModBus_locDev_dRtuW(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_remDev_dTcpO(SedonaVM* vm, Cell* params)
{
...
extern "C" Cell ModBus_remDev_dTcpC(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
...
extern "C"Cell ModBus_remDev_dTcpA(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_remDev_dTcpR(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_remDev_dTcpW(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_locDev_dTcpO(SedonaVM* vm, Cell* params)
{
...
extern "C" Cell ModBus_locDev_dTcpC(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
...
extern "C" Cell ModBus_locDev_dTcpA(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
...
extern "C" Cell ModBus_locDev_dTcpR(SedonaVM* vm, Cell* params)
{
    //	printf("[%s:%s:%d] Enter\n",
    //	 __FILE__, __FUNCTION__, __LINE__);
    int ctx_idx = params[1].ival;
...
extern "C" Cell ModBus_locDev_dTcpW(SedonaVM* vm, Cell* params)
{
    int ctx_idx = params[1].ival;
    int device_addr = params[2].ival;
    int addr = params[3].ival;
